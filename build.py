...
def pathmd5(text: str):
    ...
    numhash: str = str(
        zlib.adler32(text[pathLen:].replace('/', '\\').encode('utf-8')))
...
def alldir(path):
    ...
    for root, dirs, files in os.walk(path):
        ...
        for dir in dirs:
            ...
            filemid = ''
            for file in [
                    os.path.join(dirpath, file)[pathLen:].replace('/', '\\')
